...
public class IsThreeOfAKindPredicateTest {

    @Test
    @DisplayName("Poker hand with  3-of-a-kind should return true")
    public void testApply(){
        final Card c1 = new Card(Suit.CLUB, "5");
        final Card c2 = new Card(Suit.CLUB, "5");
        final Card c3 = new Card(Suit.CLUB, "5");
        final Card c4 = new Card(Suit.CLUB, "6");
        ...
        cards.add(c4);
        cards.add(c5);
        final boolean actual = new IsThreeOfAKindPredicate().test(cards);

        Assertions.assertTrue( actual);
    }

    @Test
    @DisplayName("Poker hand with 3,4,5,J,Q is NOT 3 of a kind")
