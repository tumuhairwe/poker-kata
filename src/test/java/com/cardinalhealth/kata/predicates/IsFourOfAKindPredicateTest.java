...
public class IsFourOfAKindPredicateTest {

    @Test
    @DisplayName("Poker hand with  4-of-a-kind is a FOUR_OF_A_KIND")
    public void testApply(){
        final Card c1 = new Card(Suit.CLUB, "5");
        final Card c2 = new Card(Suit.CLUB, "7");
        ...
        cards.add(c4);
        cards.add(c5);
        final boolean actual = new IsFourOfAKindPredicate().test(cards);

        Assertions.assertTrue( actual);
    }

    @Test
    @DisplayName("Poker hand with 3,4,5,J,Q is NOT 4 a FOUR_OF_A_KIND")
